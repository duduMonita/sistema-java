...
public class ListFornecedor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel val =  (DefaultTableModel) tbFornecedor.getModel();
        val.getDataVector().removeAllElements();
        
        DAOFornecedor daofor = new DAOFornecedor();
        List<Fornecedor> fornecedor = daofor.listaFornecedor();
        int i = 0;
        
        while(fornecedor.size() > i){
            val.addRow(new Object[] 
            {String.valueOf(fornecedor.get(i).getCnpj()),
             String.valueOf(fornecedor.get(i).getNome())}
                      );
            i++;
        }
    }
